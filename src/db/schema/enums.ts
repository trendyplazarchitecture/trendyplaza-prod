...
/** Software Hub: a directory entry is either a standalone application or a plugin belonging to one. */
export const softwareToolKind = pgEnum("software_tool_kind", ["application", "plugin"]);
