...
export const resources = pgTable(
  "resources",
  {
    ...
    descriptionAr: text(),
    /*
     * Who made it: the teacher or teachers credited on a cours, TD or TP.
     *
     * Free text and trilingual rather than a foreign key to a user. The people
     * credited are mostly not accounts on this platform, and a name is written
     * differently in Latin and Arabic script -- "Dr. Omar Latreche" and the
     * Arabic spelling are the same person, and a student reading the Arabic
     * library should see the Arabic one. Nullable in all three: plenty of
     * resources have no attribution to give.
     */
    madeByEn: text(),
    madeByFr: text(),
    madeByAr: text(),
