...
import { mediaSrcSet, productImageUrl } from "@/lib/media";
              ...
              >
                <AnimatePresence mode="wait">
                  <motion.img
                    ...
                    srcSet={mediaSrcSet(shotUrl, [480, 640, 960, 1280])}
                  ...
                  <li key={`${image.path}-${i}`} className="shrink-0">
                    ...
                    >
                      <img
                        ...
                        srcSet={mediaSrcSet(productImageUrl(image.path), [240])}
                        sizes="80px"
                        ...
                        <li key={`modal-${image.path}-${i}`} className="shrink-0">
                          ...
                          >
                            <img
                              ...
                              srcSet={mediaSrcSet(productImageUrl(image.path), [240])}
                              sizes="64px"
                              alt={image.alt || `${product.title} gallery thumbnail ${i + 1}`}
                              width={120}
                              height={120}
                              loading="lazy"
                              decoding="async"
