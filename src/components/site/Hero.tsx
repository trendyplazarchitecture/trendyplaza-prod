        ...
        <div className="mt-14 [perspective:1200px] sm:mt-18">
          ...
          >
            <div className="relative overflow-hidden rounded-xl border border-border bg-paper shadow-inner">
              {/* The LCP element on this page: explicit size so it reserves
                  its box before it loads, fetched at high priority, and in
                  four widths so a phone does not take the 1536px original. */}
              <img
                src="/Hero-image.webp"
                srcSet="/Hero-image-640.webp 640w, /Hero-image-960.webp 960w, /Hero-image-1280.webp 1280w, /Hero-image.webp 1536w"
