          ...
          >
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-4 py-2.5 text-sm font-semibold transition-colors hover:border-primary hover:text-primary"
              >
            ...
            <div className="mt-5 border-t border-border/60 pt-3 text-xs text-muted-foreground">
              <span className="font-semibold">Curriculum &amp; standards: </span>
              <a
                href="https://www.autodesk.com"
                target="_blank"
                rel="noopener noreferrer"
                className="font-medium underline decoration-border transition-colors hover:text-primary"
              >
                Autodesk
              </a>
              {" • "}
              ...
              {" • "}
              <a
                href="https://www.epau-alger.edu.dz"
                target="_blank"
                rel="noopener noreferrer"
                className="font-medium underline decoration-border transition-colors hover:text-primary"
              >
