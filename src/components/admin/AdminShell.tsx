  ...
  return (
    <div className="flex w-full lg:h-screen lg:overflow-hidden">
      ...
      <div className="min-w-0 flex-1 lg:h-full lg:overflow-y-auto">
        ...
        {/* `[transform:translateZ(0)]`: see the identical note in `PortalShell.tsx` — a sticky+backdrop-blur header inside this shell's own scroll container tears under fast scroll without its own compositing layer. */}
        <div className="sticky top-0 z-30 flex h-14 items-center justify-between gap-3 border-b border-rule bg-background/95 px-4 backdrop-blur [transform:translateZ(0)] lg:hidden">
