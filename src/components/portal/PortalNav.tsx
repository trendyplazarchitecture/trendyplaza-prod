              ...
              if (locked) {
                return (
                  <li key={key}>
                    <span
                      className={cn(
                        "flex cursor-default items-center gap-2.5 rounded-md px-3 py-2 text-sm text-muted-foreground/60",
                        collapsed && "justify-center px-0",
                      )}
                      title={collapsed ? label : soon ? t("soon") : t("lockedBadge")}
                    >
                      ...
                      <span className="sr-only">
                        {label} — {soon ? t("soon") : t("lockedBadge")}
                      </span>
                    </span>
                  </li>
                );
