...
export const SETTING_KEYS = ["instagram", "phone", "email", "ripNumber", "softwareCarouselSpeed"] as const;
...
const DEFAULTS: Record<SettingKey, string> = {
  ...
  ripNumber: "",
  // Seconds for one full pass of the logo carousel — slower reads as more
  // deliberate, faster reads as more energetic; the client's own call, not
  // baked into the component.
  softwareCarouselSpeed: "30",
};
...
const LABELS: Record<SettingKey, string> = {
  ...
  softwareCarouselSpeed: "Software logo carousel speed (seconds per loop)",
};
